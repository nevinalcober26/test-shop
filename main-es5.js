...
var ProductElement = /** @class */ (function () {
    ...
    ProductElement.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var Home1Component = /** @class */ (function () {
    function Home1Component(router) {
        this.router = router;
    }
    // Detail Product
    Home1Component.prototype.detailProduct = function (e) {
        var product = lodash__WEBPACK_IMPORTED_MODULE_4__["kebabCase"](e.slug);
        this.router.navigate(['shop/p/' + product]);
    };
    Home1Component.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var BreadcumbComponent = /** @class */ (function () {
    ...
    BreadcumbComponent.prototype.createMap = function () {
        ...
        if (activeValue == "shop") {
            setTimeout(function () {
                if (!lodash__WEBPACK_IMPORTED_MODULE_3__["isEmpty"](_this.segments[1])) {
    ...
    BreadcumbComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var GridLogoComponent = /** @class */ (function () {
    ...
    GridLogoComponent.prototype.fetch = function () {
        ...
        this.mainService.getLogo().subscribe(function (data) {
            _this.logos = [];
            lodash__WEBPACK_IMPORTED_MODULE_3__["map"](data, function (x) {
                _this.logos.push(x);
            });
            _this.limitLogo(data);
        });
    };
    GridLogoComponent.ctorParameters = function () { return [
        { type: _service_product_service__WEBPACK_IMPORTED_MODULE_4__["productService"] }
    ]; };
...
var ProductComponent = /** @class */ (function () {
    ...
    ProductComponent.prototype.fetch = function () {
        ...
        this.mainService.getProduct().subscribe(function (data) {
            _this.products = [];
            lodash__WEBPACK_IMPORTED_MODULE_3__["map"](data, function (x) {
                _this.products.push(x);
            });
            _this.limitProduct(data);
            setTimeout(function () {
                _this.loadingState = false;
...
var libHeightDirective = /** @class */ (function () {
    ...
    libHeightDirective.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    ...
    CookieService.prototype.initCookie = function () {
        ...
        if (!lodash__WEBPACK_IMPORTED_MODULE_3__["isEmpty"](this.cookies)) {
            ...
            if (this.cookies['products'] != undefined) {
                ...
                lodash__WEBPACK_IMPORTED_MODULE_3__["map"](productsCart, function (x) {
            ...
            if (this.cookies['wishlist'] != undefined) {
                ...
                lodash__WEBPACK_IMPORTED_MODULE_3__["map"](wishList, function (x) {
            ...
            if (this.cookies['compare'] != undefined) {
                ...
                lodash__WEBPACK_IMPORTED_MODULE_3__["map"](compareList, function (x) {
...
var CartComponent = /** @class */ (function () {
    ...
    CartComponent.prototype.deleteProduct = function (index) {
        lodash__WEBPACK_IMPORTED_MODULE_4__["remove"](this.productsOrder, function (n) {
            return n.id == index;
        });
        this.initTotal(this.productsOrder);
        this.cookie.addCookie('products', JSON.stringify(this.productsOrder));
...
var CompareComponent = /** @class */ (function () {
    ...
    CompareComponent.prototype.fetchProduct = function () {
        ...
        this.productService.getProduct().subscribe(function (product) {
            lodash__WEBPACK_IMPORTED_MODULE_4__["map"](_this.cookie['arrCompare'], function (x, i) {
                var findProduct = lodash__WEBPACK_IMPORTED_MODULE_4__["find"](product, function (c) {
                    return c['index'] == x;
                });
...
var DashboardProdut = /** @class */ (function () {
    ...
    DashboardProdut.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
    ]; };
...
var DetailProductComponent = /** @class */ (function () {
    ...
    DetailProductComponent.prototype.ngOnInit = function () {
        ...
        this.activeRoute.params.subscribe(function (params) {
            ...
            _this.productService.getSlugProduct(_this.productName).then(function (product) {
                ...
                // Init Demo Image
                _this.selectedImage = lodash__WEBPACK_IMPORTED_MODULE_3__["find"](product['gallery'], function (o) {
    ...
    DetailProductComponent.prototype.addCart = function (cName, cValue) {
        var obj = lodash__WEBPACK_IMPORTED_MODULE_3__["find"](this.productsOrder, ['id', this.product.id]);
        if (obj == undefined) {
    ...
    DetailProductComponent.prototype.addWishlist = function (cName, cValue) {
        var _this = this;
        var obj = lodash__WEBPACK_IMPORTED_MODULE_3__["find"](this.productWishlist, function (x) {
    ...
    DetailProductComponent.prototype.addCompare = function (cName, cValue) {
        var _this = this;
        var obj = lodash__WEBPACK_IMPORTED_MODULE_3__["find"](this.productCompare, function (x) {
            return x == _this.product['index'];
        });
        if (obj == undefined) {
    ...
    DetailProductComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
var Product3Component = /** @class */ (function () {
    function Product3Component(router, activeRoute, productService) {
        ...
        this.activeRoute.queryParams.subscribe(function (params) {
            _this.search = lodash__WEBPACK_IMPORTED_MODULE_3__["lowerCase"](params["search"]);
            _this.category = lodash__WEBPACK_IMPORTED_MODULE_3__["lowerCase"](params["category"]);
            // Pagination
            ...
            if (!lodash__WEBPACK_IMPORTED_MODULE_3__["isEmpty"](params)) {
                ...
                lodash__WEBPACK_IMPORTED_MODULE_3__["merge"](_this.objectNavigation, params);
                // Value Search
    ...
    Product3Component.prototype.initCategory = function (obj) {
        ...
        if (this.chekCategory !== undefined) {
            this.selectedCategory = lodash__WEBPACK_IMPORTED_MODULE_3__["find"](obj, function (o) {
    ...
    Product3Component.prototype.onSearch = function (e) {
        ...
        this.timeout = setTimeout(function () {
            ...
            if (e.target.value.length !== 0) {
                _this.objectNavigation['search'] = lodash__WEBPACK_IMPORTED_MODULE_3__["kebabCase"](e.target.value);
    ...
    Product3Component.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
var ShippingComponent = /** @class */ (function () {
    ...
    ShippingComponent.prototype.ngOnInit = function () {
        var products = this.cookie['productsOrder'];
        lodash__WEBPACK_IMPORTED_MODULE_5__["map"](products, function (x) {
    ...
    // ================================== //
    ShippingComponent.prototype.submitStripJS = function (form) {
        var _this = this;
    ...
    ShippingComponent.prototype.initConfig = function () {
        var _this = this;
        var items = [];
        this.productsOrder.map(function (x) {
            var obj = {
                name: x.productName,
                quantity: x.quantity,
                unit_amount: {
